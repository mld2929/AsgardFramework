...
namespace AsgardFramework.WoWAPI.Utils
{
    public class UnitMetaId
    {
        ...
        /// </summary>
        /// <remarks>
        /// You can also append it to other <see cref="UnitMetaId"/>, referring to that unit's target. This can be done repeatedly. <see cref="Player"/> + <see cref="Target"/> equals to <see cref="Target"/>
        /// </remarks>
        ...
        /// <summary>
        /// The unit the player is currently interacting with (via the Merchant, Trainer, Bank, or similar UI); not necessarily an NPC (e.g. also used in the Trade UI)
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Indices match the order party member frames are displayed in the default UI. To specify index use <see cref="this[int]"/>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Unlike with the party tokens, one of the raid unit IDs will belong to the player. Indices have no relation to the arrangement of units in the default UI. To specify index use <see cref="this[int]"/>
        /// </remarks>
        ...
        /// <summary>
        /// Specifies index of <see cref="Party"/>, <see cref="PartyPet"/>, <see cref="Raid"/>, <see cref="Raidpet"/> or <see cref="Arena"/>. Idempotent operation!
        /// </summary>
        ...
        /// <param name="right"><see cref="Target"/></param>
